...
namespace FinancialCrm
{
    public partial class FrmBankProcess : Form
    {
        ...
        private void FrmBankProcess_Load(object sender, EventArgs e)
        {
            ...
            lblBankProcess6.Text = bankProcess6.Description + " | Gelen Havale: " + bankProcess5.Amount + " ₺ | Tarih: " + bankProcess5.ProcessDate;

            var bankProcess7 = db.BankProcesses.OrderByDescending(x => x.BankProcessId).Take(7).Skip(6).FirstOrDefault();
            lblBankProcess7.Text = bankProcess7.Description + " | Gelen Havale: " + bankProcess5.Amount + " ₺ | Tarih: " + bankProcess5.ProcessDate;
        }
